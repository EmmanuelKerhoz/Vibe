...
export const useUIStateForProvider = (bag: UIStateSlice): UIStateBag => {
  const {
    ...
    setIsCloudStoragePickerOpen, setCloudStoragePickerMode,
    setIsCloudSaveOpen, setCloudSaveProvider,
    ...
    isCloudStoragePickerOpen, cloudStoragePickerMode,
    isCloudSaveOpen, cloudSaveProvider,
