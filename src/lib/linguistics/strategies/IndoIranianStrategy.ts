...
const ARABIC_IIR_MAP: Record<string, string> = { 'ا': 'ā', 'آ': 'ā', 'ب': 'b', 'پ': 'p', 'ت': 't', 'ٹ': 't', 'ث': 's', 'ج': 'j', 'چ': 'c', 'ح': 'h', 'خ': 'k', 'د': 'd', 'ڈ': 'd', 'ذ': 'd', 'ر': 'r', 'ڑ': 'r', 'ز': 'z', 'ژ': 'j', 'س': 's', 'ش': 's', 'ص': 's', 'ض': 'd', 'ط': 't', 'ظ': 'd', 'ع': '', 'غ': 'g', 'ف': 'f', 'ق': 'k', 'ک': 'k', 'گ': 'g', 'ل': 'l', 'م': 'm', 'ن': 'n', 'ں': 'n', 'و': 'ū', 'ہ': 'h', 'ھ': '', 'ء': '', 'ی': 'ī', 'ے': 'e', 'ۓ': 'e', 'ئ': 'ī', 'ؤ': 'ū', 'َ': 'a',
  'ِ': 'i', 'ُ': 'u', 'ً': 'a', 'ٍ': 'i', 'ٌ': 'u', 'ٰ': 'ā', 'ْ': '', 'ّ': '',
};
