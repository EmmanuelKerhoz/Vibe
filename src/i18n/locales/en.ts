...
const en: Translations = {
  ...
  musical: {
    ...
    generatePrompt: 'GENERATE MUSICAL PROMPT',
  ...
  saveToLibrary: {
    ...
    storageLibraryData: 'Library data',
    storageUsed: 'Browser usage',
    storageQuota: 'Browser limit',
    storageSaturation: 'Saturation',
    storageScopeLocal: 'Library data covers only lyricist_library. Browser usage and limit are global estimates for this browser when available.',
