...
const pt: Translations = {
  ...
  editor: {
    ...
    regenerateLyrics: 'Regenerar letra',
  ...
  musical: {
    ...
    promptPlaceholder: 'Seu prompt musical estruturado (STYLE, MOOD, VOCALS, INSTRUMENTATION, RHYTHM, STRUCTURE, MIX/SPACE, REFERENCES, DELIVERY) aparecerá aqui...',
    promptStructureLabel: 'Prompt estruturado',
    promptStructureHint: 'Mantenha o prompt musical etiquetado (STYLE, MOOD, VOCALS, INSTRUMENTATION, RHYTHM, STRUCTURE, MIX/SPACE, REFERENCES, DELIVERY) para que as IAs de música não percam contexto.',
  ...
  saveToLibrary: {
    ...
    storageLibraryData: 'Dados da biblioteca',
    storageUsed: 'Uso do navegador',
    storageQuota: 'Limite do navegador',
    storageSaturation: 'Saturação',
    storageScopeLocal: 'Os dados da biblioteca cobrem apenas lyricist_library. O uso e o limite do navegador são estimativas globais deste navegador quando disponíveis.',
  ...
  keyboardShortcuts: {
    ...
    description: 'Consulte os atalhos ativos disponíveis no Lyricist Pro.',
    keysColumn: 'Teclas',
    actionColumn: 'Ação',
    close: 'Fechar',
    categories: {
    ...
    shortcuts: {
      undo: 'Desfaz a alteração mais recente fora dos campos de texto.',
      redo: 'Refaz a última alteração revertida fora dos campos de texto.',
      dismissReset: 'Fecha a caixa de confirmação de redefinição.',
  ...
  tooltips: {
    ...
    keyboardShortcuts: 'Mostrar atalhos de teclado',
    closeAbout: 'Fechar',
