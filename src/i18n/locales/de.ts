...
const de: Translations = {
  ...
  editor: {
    ...
    phoneticMode: {
      title: 'Phonetischer Modus',
      description: 'Reine IPA-Ansicht deiner Liedtexte',
      hint: 'Erzeugt mit der gewählten Sprache oder dem Dialekt: {lang}',
      placeholder: 'Die phonetische Transkription erscheint hier, sobald Text vorhanden ist.',
      loading: 'Phonetische Ansicht wird erstellt…',
      error: 'Phonetische Ansicht nicht verfügbar ({error})',
    },
    sectionTooltip: {
      lines: 'Zeilen',
      words: 'Wörter',
    ...
    addMusicalEffect: 'Musikalischen / Modulationseffekt hinzufügen',
  ...
  musical: {
    ...
    promptPlaceholder: 'Dein strukturierter musikalischer Prompt (STYLE, MOOD, VOCALS, INSTRUMENTATION, RHYTHM, STRUCTURE, MIX/SPACE, REFERENCES, DELIVERY) erscheint hier...',
    promptStructureLabel: 'Strukturierter Prompt',
    promptStructureHint: 'Halte den musikalischen Prompt beschriftet (STYLE, MOOD, VOCALS, INSTRUMENTATION, RHYTHM, STRUCTURE, MIX/SPACE, REFERENCES, DELIVERY), damit Musik-KIs keinen Kontext verlieren.',
    ...
    vibeBoard: 'STIMMUNGSBOARD',
    vibeBoardDescription: 'Wähle dein Genre, um BPM & Instrumente automatisch einzustellen',
    subStyle: 'SUBSTIL',
  },
  ...
  saveToLibrary: {
    ...
    storageLibraryData: 'Bibliotheksdaten',
    storageUsed: 'Browser-Nutzung',
    storageQuota: 'Browser-Limit',
    storageSaturation: 'Auslastung',
    storageScopeLocal: 'Bibliotheksdaten umfassen nur lyricist_library. Browser-Nutzung und -Limit sind globale Schätzwerte für diesen Browser, wenn verfügbar.',
  ...
  keyboardShortcuts: {
    title: 'Tastenkürzel',
    description: 'Hier findest du die aktiven Tastenkürzel in Lyricist Pro.',
    keysColumn: 'Tasten',
    actionColumn: 'Aktion',
    close: 'Schließen',
    categories: {
    ...
    shortcuts: {
      undo: 'Macht die letzte Änderung außerhalb von Texteingaben rückgängig.',
      redo: 'Stellt die zuletzt rückgängig gemachte Änderung außerhalb von Texteingaben wieder her.',
      dismissReset: 'Schließt den Zurücksetzen-Bestätigungsdialog.',
  ...
  tooltips: {
    ...
    phoneticMode: 'In den phonetischen Modus wechseln',
    ...
    keyboardShortcuts: 'Tastenkürzel anzeigen',
