...
const createIcon = (Icon: FluentIconComponent, displayName: string) => {
  const WrappedIcon = forwardRef<HTMLElement, LucideIconProps>(function WrappedIcon(
    { size, color, style, strokeWidth: _strokeWidth, absoluteStrokeWidth: _absoluteStrokeWidth, ...props },
    ref,
  ) {
    ...
    return <Icon ref={ref as never} primaryFill="currentColor" {...props} style={mergedStyle} />;
  });
