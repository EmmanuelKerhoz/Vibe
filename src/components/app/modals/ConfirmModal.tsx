...
export function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-0 sm:p-4">
      ...
      <div
        className="lcars-gradient-outline relative w-full sm:max-w-sm h-full sm:h-auto rounded-none sm:rounded-[24px_8px_24px_8px] animate-in zoom-in-95 duration-300"
        style={{
          padding: '2px',
